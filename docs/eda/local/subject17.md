...
- **語音佔比 (Speech Ratio):** 23.67% (整體說話時間比例)
- **語音破碎度 (Fragmentation Ratio):** 61.68% (短於 1.5 秒的語句比例)
- **音高變異性 (Pitch Std Dev):** 114.63 Hz (🟢 正常範圍)

## 3. 互動與語意動態 (Interaction & Overlapping Dynamics)
- **長沈默 (>2s):** 45 次 (反映互動延遲或無反應)
- **平均語句長度:** 1.49 秒

## 4. 下游影響與分析洞察 (Downstream Impact & Insights)
- **整體品質評分 (對 ASR/Diarization 友善度):** 7/10
- **主要風險:** ✅ 適合標準流程處理，穩定度高。
- **處理建議:** 建議使用標準處理管線。
