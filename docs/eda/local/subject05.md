...
- **語音佔比 (Speech Ratio):** 46.85% (整體說話時間比例)
- **語音破碎度 (Fragmentation Ratio):** 54.91% (短於 1.5 秒的語句比例)
- **音高變異性 (Pitch Std Dev):** 103.67 Hz (🟢 正常範圍)

## 3. 互動與語意動態 (Interaction & Overlapping Dynamics)
- **長沈默 (>2s):** 105 次 (反映互動延遲或無反應)
- **平均語句長度:** 1.81 秒
