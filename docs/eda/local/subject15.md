...
- **語音佔比 (Speech Ratio):** 14.71% (整體說話時間比例)
- **語音破碎度 (Fragmentation Ratio):** 66.54% (短於 1.5 秒的語句比例)
- **音高變異性 (Pitch Std Dev):** 98.94 Hz (🟢 正常範圍)

## 3. 互動與語意動態 (Interaction & Overlapping Dynamics)
- **長沈默 (>2s):** 69 次 (反映互動延遲或無反應)
- **平均語句長度:** 1.28 秒

## 4. 下游影響與分析洞察 (Downstream Impact & Insights)
- **整體品質評分 (對 ASR/Diarization 友善度):** 3/10
